...
if (!empty($dados['CadUsuario'])) {
    ...
    if (!$empty_input) {
        $query_contatos = "INSERT INTO contatos (id, nome, sobre_nome, data_nascimento, telefone, celular, email) VALUES (:id, :nome, :sobre_nome, :data_nascimento, :telefone, :celular, :email) ";
        $cad_contatos = $conn->prepare($query_contatos);
        $cad_contatos->bindParam(':id', $id['id'], PDO::PARAM_INT);
